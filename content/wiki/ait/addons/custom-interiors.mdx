...
- Using whatever arts and crafts image editor you like (I recommend **paint.net** or **Gimp**), create a photo for your desktop in a _SQUARE_ format.
...
Use a **Structure Block** to save your interior. First save your interior, and note down your namespace (before the colon) and desktop name (after the colon) The _.nbt_ will be saved to `.minecraft/saves/WorldName/generated/namespace/structures`. (`namespace` is usually `minecraft`)
