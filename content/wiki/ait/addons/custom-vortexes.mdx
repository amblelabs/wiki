...
3. Replace `vortex_name` with what ever you want the vortex to be named (you NEED to use underscores and lowercase for the name). This name is automatically translated so doesn't need to be added to your language file.
