...
3. Replace `vortex_name` with what ever your texture is named (you NEED to use underscores and lowercase for the texture, but don't need too for the name). This name is automatically translated so doesn't need to be added to your language file.
