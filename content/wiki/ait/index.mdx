...
AiT can be found on Modrinth and Curseforge.
- [Modrinth](https://modrinth.com/mod/adventures-in-time)
...
If you find any bugs / crashes, please create a GitHub Issue or ask for help in the support channel in the Amble Labs Discord.
- [GitHub Issue](https://github.com/amblelabs/ait/issues/new?template=1-bug-report.yaml)
- [Amble Labs Discord](https://discord.gg/ZXQdFxTNKh)
...
TODO: list writers and support members
