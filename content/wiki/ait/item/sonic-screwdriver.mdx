...
To **charge** a Sonic Screwdriver insert it into a [**TARDIS Console**](/tardis/console) (you can also `Right Click` on a rift OR an [artron collector](../blocks/artron-collector) to charge it too) like you would for linking it to the TARDIS then, the Sonic Screwdriver should start charging (keep in mind the Sonic Screwdriver uses the [**Artron Energy**](/tardis/artron-energy/) to charge).
